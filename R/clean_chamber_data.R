...
sporo_2012_chamber <- bind_rows(
  parse_logger_dat("data/2012/filmyDT2_LiCl.csv") %>% mutate(salt = "LiCl"),
  parse_logger_dat("data/2012/filmyDT2_MgNO3.csv") %>% mutate(salt = "MgNO3"),
  parse_logger_dat("data/2012/filmyDT2_NaCl.csv") %>% mutate(salt = "NaCl")
)
...
gameto_2012_chamber <-
  bind_rows(
    parse_logger_dat("data/2012/gameto1_7-14.csv"),
    parse_logger_dat("data/2012/gameto2_7-24.csv")
  ) %>% mutate(salt = "MgNO3")
