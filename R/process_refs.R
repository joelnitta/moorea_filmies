...
read_lines("ms/references.bib") %>%
  ...
  # Fix journal abbreviations that are not automatically generated by Zotero
  str_replace_all("Environmental and Experimental Botany", "Environ. Exp. Bot.") %>%
  str_replace_all("International Journal of Plant Sciences", "Int. J. Plant Sci.") %>%
  str_replace_all("Biochimica et Biophysica Acta (BBA) - Bioenergetics", "Biochim. Biophys. Acta") %>%
  str_replace_all("Annals of Botany", "Ann. Bot.") %>% 
  str_replace_all("South African Journal of Botany", "S. Afr. J. Bot.") %>%
