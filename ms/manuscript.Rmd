...
figname <- figure("dt") %>% str_remove_all("[:punct:]| ") %>% paste0("a.pdf")
ggsave(file = here::here("results/ms", figname), width = 6.85, height = 7.5)
```
...
figname <- figure("dt") %>% str_remove_all("[:punct:]| ") %>% paste0("b.pdf")
ggsave(here::here("results/ms", figname), width = 6.85, height = 6.5, device = "pdf")
```
...
figname <- figure("combined") %>% str_remove_all("[:punct:]| ") %>% paste0(".pdf")
ggsave(here::here("results/ms", figname), width = 6.85, height = 5)
```
...
figname <- figure("corr") %>% str_remove_all("[:punct:]| ") %>% paste0(".pdf")
ggsave(here::here("results/ms", figname), width = 6.85, height = 5)
```
