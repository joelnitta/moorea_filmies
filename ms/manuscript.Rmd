...
A total of `r n_filmy_sp` filmy fern species are known from Moorea, including multiple terrestrial, saxicolous, and epiphytic species [@Murdock2003; @Ranker2005; @Nitta2011b; @Nitta2017; @Florence].
...
# Make helper function to check on p-value significance and extract from t_test_results
#
...
A general correlation of DT with habitat was observed in sporophytes (`r figure("sporo-dt")`).
...
**`r figure("sporo-dt")`** Results of desiccation tolerance test on filmy fern sporophytes (**a**) and gametophytes (**b**) from Moorea, French Polynesia.
...
```{r sporo-dt-plot, fig.width = 6.85, fig.height = 7.5, fig.cap = ""}
dt_plot_data %>%
