...
^3^Current address: Section of Plant Pathology and Plant-Microbe Biology, Cornell University, Ithaca, New York 14853 USA
...
Gametophytes had similar or less desiccation tolerance and lower photosynthetic optima (maximum electron transport rate of photosystem II and light level at 95% of that rate) than sporophytes.
...
In epiphytic *Hymenoglossum cruentum* Cav. from Chile, key genes and gene networks were identified related to intracellular mobility and photosynthetic metabolism in the desiccated state, and those related to detoxifying pathways and stabilization of photosystems during rehydration [@Ostria-Gallardo2020a].
...
*Crepidomanes bipunctatum* (Poir.) Copel., a widespread low-elevation epiphyte, showed the greatest ability to recover from desiccation across all treatments.
...
Brief fluctuations in humidity were observed when chambers were opened to insert or remove samples (`r s_figure("chamber-s")`).
