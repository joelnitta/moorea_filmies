...
Joel H. Nitta^1,4^, James E. Watkins, Jr.^2^, N. Michele Holbrook^1^, Tristan W. Wang^3^, and Charles C. Davis^1^
...
^3^Section of Plant Pathology and Plant-Microbe Biology, Cornell University, Ithaca, New York 14853 USA
...
However, little is known about the transition from desiccation tolerant non-vascular plants to desiccation avoiding vascular ones.
...
To explore this, we surveyed sporophytes and gametophytes of 22 species of filmy ferns on Moorea (French Polynesia) and used chlorophyll fluorescence to measure desiccation tolerance and light responses.
...
The transition from aquatic to terrestrial growth was complex, requiring a suite of evolutionary adaptations to survive in dry habitats bombarded with radiation [@Waters2003].
...
The sporophytes of most filmy ferns are relatively small, with many less than \circa{ }10 cm.
...
A total of `r n_filmy_sp` filmy fern species are known from Moorea, including multiple terrestrial, saxicolous, and epiphytic species [@Florence; @Murdock2003; @Nitta2011b; @Nitta2017; @Ranker2005] (\figs `r figure_num("habit")`, `r s_figure_num("tree")`; all supplemental figures available in Online Resource 1).
...
This tree is in accord with previously published, more densely sampled phylogenies [@Dubuisson2003; @Ebihara2007a; @Hennequin2006; @Pryer2001a].
...
Vegetative DT was a key innovation linked to the rise of early land plants, but is largely limited to non-vascular groups such as bryophytes and algae in extant plants.
Filmy ferns have received considerable attention over the years for their remarkable reversion to vegetative DT in the sporophyte phase [\eg, @GarcesCea2014; @Proctor2003; @Shreve1911].
