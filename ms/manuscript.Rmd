...
Moorea is a small (135 km^2^; maximum elevation 1206 m) tropical oceanic island, located ca. 15 km NW of its larger sister island, Tahiti.
...
We characterized the microenvironment experienced by filmy ferns by logging relative humidity (RH) and temperature every 15 min from July 7, 2013 to July 5, 2014 at 16 of the sampling sites (Fig. 2).
...
We used DNA barcoding to identify filmy fern gametophytes to species as described in Nitta et al. (2016).
...
All statistical analyses were done in R v.3.2.1 (R Core Team, 2015).
...
We included species as a random effect in all models, and included a phylogenetic variance-covariance matrix only for response variables with significant phylogenetic signal (Hadfield, 2010).
