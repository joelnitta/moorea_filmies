...
The GLMM including the effect of life stage only was selected as the best-fitting model for ETR~max~, and the combined effect of growth habit plus life stage and their interaction was selected for PPFD~95%~ (`r table("glmm")`).
...
Asterisk indicates significant difference in means (*P* <0.05) between life stages for a particular species (*t*-test); ns indicates no significant difference; lack of ns or asterisk means not enough observations available for that species for *t*-test.
...
**`r figure("corr")`** Recovery of F~v~/F~m~ (%) following 2 days desiccation at –86 MPa plotted against environmental vapor pressure deficit (VPD; kPa) (**a**, **b**) or range of gametophytes beyond sporophytes (m) (**c**) for gametophytes (**a**, **c**) or sporophytes (**b**). 
