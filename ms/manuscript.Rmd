...
\*\*\* NOTE TO REVIEWERS: The dataset and code will not be made public until the paper is accepted. While the paper is under review, these links can be used for the dataset (https://figshare.com/s/d6349abf01a3756a5aae) and code (https://www.dropbox.com/sh/h788g1h3sjcqj0j/AACwFWTmL6GxrbLkCfOrXZU9a?dl=0)  \*\*\*
...
make_dt_plot(dt_plot_data, "sporophyte", "a")
