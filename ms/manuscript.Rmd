...
<!-- FIXME: check on these numbers DT of gametophytes did not significantly exceed that of sporophytes for any species except for saxicolous *P. endlicherianum* (Fig. 5; *t*-test, *P* = `r ttest_pval("Polyphlebium_endlicherianum", "recovery")`), and was significantly lower in gametophytes than sporophytes of some high elevation epiphytic species including *C. minutum* var. 2, *H.* *digitatum*, *H. polyanthos*, and *P. borbonicum* (Fig. 5; *t*-test, *P* = `r ttest_pval("Crepidomanes_minutum2", "recovery")`, `r ttest_pval("Hymenophyllum_digitatum", "recovery")`, `r ttest_pval("Hymenophyllum_polyanthos", "recovery")`, and `r ttest_pval("Polyphlebium_borbonicum", "recovery")`, respectively). -->
