...
# Part a (left): tree
a <- ggtree(phy) %<+% habit +
  geom_tippoint(aes(color = habit), position = position_nudge(x = 7, y = 0), size = 4) +
...
b <- 
ggplot(traits, aes(y = species, x = recovery_mean, fill = generation)) +
  geom_col(position = position_dodge(0.5, preserve = "single"), width = 0.5) +
  geom_errorbarh(
    aes(xmax = recovery_mean + recovery_sd, xmin = recovery_mean),
...
c <-
ggplot(traits, aes(y = species, x = etr_mean, fill = generation)) +
  geom_col(position = position_dodge(0.5, preserve = "single"), width = 0.5) +
  geom_errorbarh(
    aes(xmax = etr_mean + etr_sd, xmin = etr_mean),
    position = position_dodge(0.5, preserve = "single"),
    height = 0,
    color = "grey20") +
  theme_bw(base_size = 10) +
